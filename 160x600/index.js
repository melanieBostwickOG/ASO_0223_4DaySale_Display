...
}).prototype = getMCSymbolPrototype(lib.banner_1, new cjs.Rectangle(0,0,160,600), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(80,407,0.3,0.3,0,0,0,80,407);
	...
	mask._off = true;
	var mask_graphics_61 = new cjs.Graphics().p("AsLCMIAAkXIYXAAIAAEXg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(61).to({graphics:mask_graphics_61,x:-58,y:295}).wait(1).to({graphics:mask_graphics_62,x:-58,y:295}).wait(1).to({graphics:mask_graphics_63,x:-58,y:295}).wait(1).to({graphics:mask_graphics_64,x:-57.95,y:295}).wait(1).to({graphics:mask_graphics_65,x:-57.8,y:295}).wait(1).to({graphics:mask_graphics_66,x:-57.55,y:295}).wait(1).to({graphics:mask_graphics_67,x:-57.05,y:295}).wait(1).to({graphics:mask_graphics_68,x:-56.2,y:295}).wait(1).to({graphics:mask_graphics_69,x:-54.95,y:295}).wait(1).to({graphics:mask_graphics_70,x:-53.1,y:295}).wait(1).to({graphics:mask_graphics_71,x:-50.55,y:295}).wait(1).to({graphics:mask_graphics_72,x:-47.05,y:295}).wait(1).to({graphics:mask_graphics_73,x:-42.55,y:295}).wait(1).to({graphics:mask_graphics_74,x:-36.7,y:295}).wait(1).to({graphics:mask_graphics_75,x:-29.35,y:295}).wait(1).to({graphics:mask_graphics_76,x:-20.2,y:295}).wait(1).to({graphics:mask_graphics_77,x:-9.1,y:295}).wait(1).to({graphics:mask_graphics_78,x:4.35,y:295}).wait(1).to({graphics:mask_graphics_79,x:19.65,y:295}).wait(1).to({graphics:mask_graphics_80,x:33.1,y:295}).wait(1).to({graphics:mask_graphics_81,x:44.2,y:295}).wait(1).to({graphics:mask_graphics_82,x:53.35,y:295}).wait(1).to({graphics:mask_graphics_83,x:60.7,y:295}).wait(1).to({graphics:mask_graphics_84,x:66.5,y:295}).wait(1).to({graphics:mask_graphics_85,x:71.05,y:295}).wait(1).to({graphics:mask_graphics_86,x:74.55,y:295}).wait(1).to({graphics:mask_graphics_87,x:77.1,y:295}).wait(1).to({graphics:mask_graphics_88,x:78.95,y:295}).wait(1).to({graphics:mask_graphics_89,x:80.2,y:295}).wait(1).to({graphics:mask_graphics_90,x:81.05,y:295}).wait(1).to({graphics:mask_graphics_91,x:81.55,y:295}).wait(1).to({graphics:mask_graphics_92,x:81.8,y:295}).wait(1).to({graphics:mask_graphics_93,x:81.95,y:295}).wait(1).to({graphics:mask_graphics_94,x:82,y:295}).wait(1).to({graphics:mask_graphics_95,x:82,y:295}).wait(1).to({graphics:mask_graphics_96,x:82,y:295}).wait(84));
	...
	this.instance_5.setTransform(150,37,1,1,0,0,0,150,125);
...
p.nominalBounds = new cjs.Rectangle(74.5,212,91.19999999999999,401.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1676656941599", id:"back"},
		{src:"images/banner.png?1676656941599", id:"banner"},
		{src:"images/cta.png?1676656941599", id:"cta"},
		{src:"images/head1.png?1676656941599", id:"head1"},
		{src:"images/head2.png?1676656941599", id:"head2"},
		{src:"images/logo.png?1676656941599", id:"logo"},
		{src:"images/stroke.png?1676656941599", id:"stroke"}
	],
	preloads: []
};
