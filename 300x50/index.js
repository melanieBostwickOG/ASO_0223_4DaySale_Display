...
}).prototype = getMCSymbolPrototype(lib.banner_1, new cjs.Rectangle(0,0,300,50), null);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_58 = new cjs.Graphics().p("AjbBaIAAizIG3AAIAACzg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(58).to({graphics:mask_graphics_58,x:100.575,y:44}).wait(1).to({graphics:mask_graphics_59,x:100.575,y:44}).wait(1).to({graphics:mask_graphics_60,x:100.575,y:44}).wait(1).to({graphics:mask_graphics_61,x:100.575,y:44}).wait(1).to({graphics:mask_graphics_62,x:100.625,y:44}).wait(1).to({graphics:mask_graphics_63,x:100.725,y:44}).wait(1).to({graphics:mask_graphics_64,x:100.875,y:44}).wait(1).to({graphics:mask_graphics_65,x:101.075,y:44}).wait(1).to({graphics:mask_graphics_66,x:101.475,y:44}).wait(1).to({graphics:mask_graphics_67,x:101.975,y:43.95}).wait(1).to({graphics:mask_graphics_68,x:102.725,y:43.95}).wait(1).to({graphics:mask_graphics_69,x:103.725,y:43.9}).wait(1).to({graphics:mask_graphics_70,x:105.025,y:43.9}).wait(1).to({graphics:mask_graphics_71,x:106.725,y:43.85}).wait(1).to({graphics:mask_graphics_72,x:108.825,y:43.8}).wait(1).to({graphics:mask_graphics_73,x:111.475,y:43.75}).wait(1).to({graphics:mask_graphics_74,x:114.675,y:43.65}).wait(1).to({graphics:mask_graphics_75,x:118.575,y:43.55}).wait(1).to({graphics:mask_graphics_76,x:122.975,y:43.45}).wait(1).to({graphics:mask_graphics_77,x:126.875,y:43.35}).wait(1).to({graphics:mask_graphics_78,x:130.075,y:43.25}).wait(1).to({graphics:mask_graphics_79,x:132.725,y:43.2}).wait(1).to({graphics:mask_graphics_80,x:134.825,y:43.15}).wait(1).to({graphics:mask_graphics_81,x:136.525,y:43.1}).wait(1).to({graphics:mask_graphics_82,x:137.825,y:43.1}).wait(1).to({graphics:mask_graphics_83,x:138.825,y:43.05}).wait(1).to({graphics:mask_graphics_84,x:139.575,y:43.05}).wait(1).to({graphics:mask_graphics_85,x:140.075,y:43}).wait(1).to({graphics:mask_graphics_86,x:140.475,y:43}).wait(1).to({graphics:mask_graphics_87,x:140.675,y:43}).wait(1).to({graphics:mask_graphics_88,x:140.825,y:43}).wait(1).to({graphics:mask_graphics_89,x:140.925,y:43}).wait(1).to({graphics:mask_graphics_90,x:140.975,y:43}).wait(1).to({graphics:mask_graphics_91,x:140.975,y:43}).wait(1).to({graphics:mask_graphics_92,x:140.975,y:43}).wait(1).to({graphics:mask_graphics_93,x:140.975,y:43}).wait(30));
...
p.nominalBounds = new cjs.Rectangle(149,-3,152,63);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1676657965838", id:"back"},
		{src:"images/banner.png?1676657965838", id:"banner"},
		{src:"images/head1.png?1676657965838", id:"head1"},
		{src:"images/head2.png?1676657965838", id:"head2"},
		{src:"images/logo.png?1676657965838", id:"logo"},
		{src:"images/stroke.png?1676657965838", id:"stroke"}
	],
	preloads: []
};
